...
public class HospitalDAOImp implements HospitalDAO{
	...
	private final String SQL_GET_ALL_AVL_SLOTS = "SELECT * FROM ms_appointment_slot_calendar WHERE slot_doc_id = ?";
	...
	@Override
	public List<SlotAvl> getAllAvailableSlots(int doc_id) {
		return jdbcTemplate.query(SQL_GET_ALL_AVL_SLOTS, new Object[] { doc_id }, new SlotAvlMapper());
	}
}
